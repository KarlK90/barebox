...
static inline int bootm_load_fit_os(struct image_data *data, unsigned long load_address)
{
    return -ENOSYS;
}

static inline struct resource *
bootm_load_fit_initrd(struct image_data *data, unsigned long load_address)
{
